...
function extract_ED_and_SD_from_mask_RANDOM( which_ROI , subjnum  , rerun, mode)
...
path_savedat   = fullfile(path_data, 'extracted_voxels', int2str(subjnum), 'random_changes');
...
sfile = [path_savedat '/' which_ROI '_corr_RANDOM.mat'];
disp(sfile)
